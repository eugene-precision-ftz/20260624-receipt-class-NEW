...
DROP FUNCTION IF EXISTS preftz.get_added_derivative_tariffs_struc(varchar, integer, varchar, varchar, TIMESTAMP, BOOLEAN, BOOLEAN);

CREATE OR REPLACE FUNCTION preftz.get_added_derivative_tariffs_struc (
...
--    RAISE NOTICE '------------------------------------------------p_part_number: p_date:%,  %', p_part_number, p_date;
