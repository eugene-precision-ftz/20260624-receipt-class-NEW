DROP FUNCTION IF EXISTS preftz.get_added_tariffs_struc;

CREATE OR REPLACE FUNCTION preftz.get_added_tariffs_struc (
...
BEGIN
    ...
    -- raise notice '----- %, %, %, %, %', v_232_exclusion, v_301_exclusion, v_chapter98_override, v_used_for_production_or_repair, v_exlusion_tariffs;
