-- PROCEDURE: preftz.calculate_derivative_duty_liability(integer)

-- DROP PROCEDURE IF EXISTS preftz.calculate_derivative_duty_liability(integer);

CREATE OR REPLACE PROCEDURE preftz.calculate_derivative_duty_liability(
...
BEGIN
    ...
    JOIN preftz.receipt_classifications rc_base ON r.receiptid = rc_base.receiptid 
    ...
    IF v_steel_cnt + v_aluminum_cnt + v_copper_cnt > 0 THEN
        ...
        END LOOP;  -- Loop thru receipt_classifications
